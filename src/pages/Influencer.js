                    ...
                    <div className="row">
                        {
                            (type === "mobile") ? (
                                ...
                                <div className="col-xl-2 fixed-left pt-5 mt-5">
                                    <ul className="navbar-nav ms-auto mb-2 pt-4">
                                ...
                                (this.state.profileStatus === false) ? (
                                    ...
                                    <>
                                        <div className="col-xl-6 col-12">
                                            <div className={`${type === 'mobile' && this.state.collapse === true ? 'd-none' : 'visible'} ${type === 'desktop' ? 'ms-5 ps-5' : ''}`}>
